...
func RegisterRoutes(e *echo.Echo, classMaterialService *service.ClassMaterialService, keywordService *service.KeywordService) {
    ...
    e.GET("/class-material/courseId/:courseId", classMaterialController.GetByCourseId)
    e.GET("/class-material/objectiveId/:objectiveId", classMaterialController.GetByObjectiveId)
    e.GET("/class-material/materialId/:materialId", classMaterialController.GetByMaterialId)
